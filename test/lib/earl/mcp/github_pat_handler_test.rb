...
module Earl
  module Mcp
    class GithubPatHandlerTest < Minitest::Test
      setup do
      ...
      test "create normalizes permission access levels to lowercase" do
        ...
        assert_equal({ "contents" => "write" }, @safari.apply_permissions_calls.first)
      end
      ...
      test "create uses default 365 day expiration" do
        ...
        assert_equal 365, @safari.apply_expiration_calls.first
      end
      ...
      test "create uses custom expiration when provided" do
        ...
        assert_equal 30, @safari.apply_expiration_calls.first
      end
      ...
      test "create sets all requested permissions" do
        ...
        @handler.call("manage_github_pats", args)
        assert_equal({ "contents" => "write", "issues" => "read" }, @safari.apply_permissions_calls.first)
      end
      ...
      test "create calls safari methods in correct order" do
        ...
        @handler.call("manage_github_pats", valid_create_args)
        expected = %w[navigate fill_token_name apply_expiration select_repository
                      apply_permissions click_generate confirm_generation extract_token]
      ...
      class MockSafariAdapter
        ...
        attr_reader :navigated_urls, :filled_names, :apply_expiration_calls,
                    :selected_repos, :apply_permissions_calls, :generate_clicked,
        ...
        def initialize
          ...
          @navigated_urls = []
          @filled_names = []
          @apply_expiration_calls = []
          @selected_repos = []
          @apply_permissions_calls = []
          @generate_clicked = 0
        ...
        def apply_expiration(days)
          @call_log << "apply_expiration"
          @apply_expiration_calls << days
        end
        ...
        def apply_permissions(permissions)
          @call_log << "apply_permissions"
          @apply_permissions_calls << permissions
        end
